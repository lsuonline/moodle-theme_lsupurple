...
class hook_callbacks {
    ...
    public static function add_font_links(\core\hook\output\before_standard_head_html_generation $hook): void {
        ...
        $hook->add_html('<link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Roboto+Condensed:ital,wght@0,400;0,700;1,400;1,700&family=Roboto:ital,wght@0,400;0,700;0,900;1,400;1,700;1,900&display=swap">');
